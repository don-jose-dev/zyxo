      ...
      <div className="container mx-auto px-6 relative z-10 max-w-5xl flex flex-col items-center justify-center">
        ...
        <div className="inline-block mb-8 px-4 py-1.5 border border-white/10 rounded-full bg-white/5 backdrop-blur-md">
            <span className="text-xs font-mono text-zyxo-green tracking-[0.2em] uppercase flex items-center gap-3">
                <span className="w-1.5 h-1.5 bg-zyxo-green rounded-full animate-pulse shadow-[0_0_10px_#ccff00]"></span>
                Enterprise Grade
            </span>
        </div>

        <h1 className="text-4xl md:text-7xl font-bold mb-8 leading-tight text-center max-w-4xl mx-auto tracking-tight">
        ...
        >
          ...
          >
            ...
            <div className="absolute inset-0 bg-zyxo-green/20 transform -skew-x-12 translate-x-full group-hover:translate-x-0 transition-transform duration-300" />
          </button>
        </motion.div>
